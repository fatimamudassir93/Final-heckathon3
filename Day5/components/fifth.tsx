...
const Fifth = () => {
  return (
    <div className="bg-[#FCF8F3] flex flex-col md:flex-row items-center md:items-start md:pl-20 pb-16">
      <div className="text-center md:text-left pt-10 md:w-1/2">
      ...
      <div className="flex flex-wrap justify-center gap-6 mt-10 md:mt-0 md:pl-20 md:w-1/2">
        <Image height={486} width={372} alt="Room 1" src="/me1.jpg" />
        <Image height={486} width={372} alt="Room 2" src="/me2.jpg" />
        <Image height={486} width={372} alt="Room 3" src="/me8.jpg" />
      </div>
    </div>
  );
};
