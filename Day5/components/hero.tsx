...
const Hero = () => {
  return (
    <section className="bg-bannerImg relative bg-repeat bg-cover bg-bottom w-full h-screen flex items-center">
      <div className="absolute right-12 top-36 bg-[#FFF3E3] p-8 rounded-lg shadow-lg max-w-xs md:max-w-lg">
        ...
        <Link href="/shop">
          <Button className="text-white bg-[#B88E2F] mt-5">Buy Now</Button>
        </Link>
      </div>
    </section>
  );
