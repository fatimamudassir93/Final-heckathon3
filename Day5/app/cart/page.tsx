...
const Cart = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <header className="bg-[url('/cart.png.png')] bg-cover bg-center h-48 md:h-60 flex items-center justify-center"></header>
      ...
      <main className="max-w-7xl mx-auto px-4 py-10">
        {cart.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            <div className="md:col-span-8 bg-white p-6 shadow-md rounded-md overflow-x-auto">
                ...
                <tbody>
                  {cart.map((item) => (
                    <tr key={item.id} className="border-b border-gray-200">
                      ...
                      <td className="py-4 px-4 text-gray-800 font-semibold text-sm md:text-base">Rs. {(item.price * item.quantity).toFixed(2)}</td>
            ...
            <div className="md:col-span-4 bg-white p-6 shadow-md rounded-md">
